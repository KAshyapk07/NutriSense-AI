"""
Tests for LLMEngine — structured nutrition estimation, modification,
...
class TestEstimateSingleDishNutrition:
    ...
    def test_invalid_json_structure_falls_back(self):
        """LLM returns JSON that doesn't match the schema → fallback."""
        bad_client = MagicMock()
    ...
    def test_partial_json_falls_back(self):
        """LLM returns only some keys → ValidationError → fallback."""
